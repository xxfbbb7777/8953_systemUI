...
public class KeyguardViewMediator extends SystemUI {
    ...
    private void setupLocked() {
        ...
        filter.addAction("SHOW_KEYGUARD");
        filter.addAction("com.android.screenlock");
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if("SHOW_KEYGUARD".equals(intent.getAction())){	
		              doKeyguardLocked(null);	
		           }
        	  if("com.android.screenlock".equals(intent.getAction())){
        		  doKeyguardLocked(null);
              }
        	  else  if (DELAYED_KEYGUARD_ACTION.equals(intent.getAction())) {
