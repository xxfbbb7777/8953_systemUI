...
public class BluetoothTile extends QSTile<QSTile.BooleanState>  {
    ...
    protected void handleClick() {
    	String GN_isOpenBt=SystemProperties.get("persist.sys.lovdream.bluetooth");
    	if(GN_isOpenBt.equals("0")){
    		return;
    	}
    ...
    public boolean isAvailable() {
    	isNoBT= SystemProperties.getBoolean("ro.product.nobt",false);
    	if(isNoBT){
    		return false;
    	}else{
