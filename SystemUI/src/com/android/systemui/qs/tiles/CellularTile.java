...
public class CellularTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        if(!mDetailAdapter.IsAirModeOn(mContext)){
        	 state.label = cb.enabled
                     ? removeTrailingPeriod(cb.enabledDesc)
                     : r.getString(R.string.quick_settings_rssi_emergency_only);
        	}else state.label=mContext.getString(R.string.keyguard_missing_sim_message_no_service);
        ...
        if (cb.noSim) {
            ...
            state.label = r.getString(R.string.quick_settings_rssi_emergency_only);
        } else {
    ...
    private final class CellularDetailAdapter implements DetailAdapter {
        ...
        public void setMobileDataEnabled(boolean enabled) {
        	...
        	else fireToggleStateChanged(enabled);	
        }
    }
}
