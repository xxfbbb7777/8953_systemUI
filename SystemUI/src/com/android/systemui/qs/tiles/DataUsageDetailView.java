...
public class DataUsageDetailView extends LinearLayout {
    ...
    public void bind(DataUsageController.DataUsageInfo info) {
        ...
        //---------------------------------------------------
        String carrier_text = info.carrier;
        String ct = getResources().getString(R.string.CT);
        String cmcc = getResources().getString(R.string.CMCC);
        String unicom = getResources().getString(R.string.UNICOM);
        if(carrier_text.contains("CT")) carrier_text=carrier_text.replaceAll("CT", ct);
        else if(carrier_text.contains("CMCC")) carrier_text=carrier_text.replaceAll("CMCC", cmcc);
        else if(carrier_text.contains("UNICOM")) carrier_text=carrier_text.replaceAll("UNICOM", unicom);
        carrier.setText(carrier_text);
        //-------------------------------------------------------------------------------------------
