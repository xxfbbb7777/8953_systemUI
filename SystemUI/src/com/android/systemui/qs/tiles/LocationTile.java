...
public class LocationTile extends QSTile<QSTile.BooleanState> {
    ...
    private class LocationBroadcastReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			if("com.lovdream.closeLoaction".equals(intent.getAction())){
				handleClick();
			}else if("com.lovdream.openLoaction".equals(intent.getAction())){
				handleClick();
			}
		}
    ...
    public LocationTile(Host host) {
        ...
        filter.addAction("com.lovdream.closeLoaction");
        filter.addAction("com.lovdream.openLoaction");
        mContext.registerReceiver(locationBroadcastReceiver, filter);
    ...
    protected void handleClick() {
        ...
        final boolean wasEnabled = (Boolean) mState.value;
        MetricsLogger.action(mContext, getMetricsCategory(), !wasEnabled);
        String GN_isOpenLocation=SystemProperties.get("persist.sys.lovdream.location");
    	if(GN_isOpenLocation.equals("false")){
