...
public class SignalClusterView
    ...
    private boolean isMultiSimEnabled =true ;
    //----------------
    ImageView mVpn, mEthernet, mWifi, mAirplane,
                mNoSims, mNoSims2,mEthernetDark, mWifiDark, mNoSimsDark, mImsOverWifiImageView,
                mMobileImsImageView;
    ...
    protected void onFinishInflate() {
        ...
        //---------------------
        isMultiSimEnabled = TelephonyManager.getDefault().isMultiSimEnabled();
    ...
    private void apply() {
		...
		//start fix bug 14644 show two sim information 	replace one
        ...
        if (mIsAirplaneMode) {
            ...
            //start when opening AirplaneMode hide NoSimsCombo icon
            mNoSimsCombo.setVisibility(View.GONE);
            //end
            //-----------------
            if(isMultiSimEnabled) mNoSimsCombo2.setVisibility(View.GONE);
            //-----------------------
        } else {
        	//start when opening AirplaneMode hide NoSimsCombo icon
            ...
            //end
        	//----------------
        	if(isMultiSimEnabled)  mNoSimsCombo2.setVisibility(!isno2 ? View.VISIBLE : View.GONE);
        	//---------------
