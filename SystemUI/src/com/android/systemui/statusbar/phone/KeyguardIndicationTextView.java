...
public class KeyguardIndicationTextView extends TextView {
    ...
    public void switchIndication(CharSequence text) {
        ...
        if (TextUtils.isEmpty(text)) {
        	...
        	//add by xxf ,here ,write dead.
        	String s_text = text.toString();
        	String text_replace = getResources().getString(R.string.keyguard_indication_charging_time);
        	if(s_text.contains(text_replace)){
        		setText(text_replace);
        	}else{
        		setText(text);
        	}
