...
public class MobileSignalController extends SignalController<
    ...
    public void handleBroadcast(Intent intent) {
        ...
        if (action.equals(TelephonyIntents.SPN_STRINGS_UPDATED_ACTION)) {
        	...
        	Log.d("fixbug_15078", "ACTION_LOCALE_CHANGED------>");
        	try{
        		Log.d("fixbug_15078", "mConfig.showLocale-->"+mConfig.showLocale);
        		Thread.sleep(1500);
                if (/*mConfig.showLocale*/ true) {
                    updateNetworkName(mLastShowSpn, mLastSpn, mLastDataSpn, mLastShowPlmn, mLastPlmn);
                    notifyListenersIfNecessary();
                }
        	}catch(Exception e){
        		Log.d("fixbug_15078", "Exception-->"+e.toString());
        	}
        }
    }
    ...
    void updateNetworkName(boolean showSpn, String spn, String dataSpn,
        ...
        if (str.length() != 0) {
        	...
        	String mNetworkNameDefault1 = getStringIfExists(
                     com.android.internal.R.string.lockscreen_carrier_default);
            mCurrentState.networkName = mNetworkNameDefault1;
        }
